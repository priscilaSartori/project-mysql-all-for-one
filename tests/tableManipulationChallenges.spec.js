...
describe('Desafios de manipulação de tabelas', () => {
  ...
  beforeEach(async () => {
    ...
    await sequelize.query('USE northwind_test;', { type: 'RAW' });
  });
  ...
  describe('Queries de inserção', () => {
    ...
    const lastOrderDetailsIdsQuery = (limit = 1) =>
      `SELECT id FROM order_details ORDER BY id DESC LIMIT ${limit};`;
  ...
  describe('Queries de atualização', () => {
    ...
    describe("22 - Atualize todos os dados da coluna 'discount', na tabela 'order_details', para 15.", () => {
